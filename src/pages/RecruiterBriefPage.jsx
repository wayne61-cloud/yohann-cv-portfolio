...
const briefContent = {
  fr: {
    ...
    valuePoints: [
      ...
      'Déclarations de TVA et suivi des échéances',
      'Maîtrise opérationnelle d\'Excel et Pennylane',
      'Relation client et qualité de suivi documentaire',
    ],
    toolsTitle: 'Outils et environnement',
    tools: ['Pennylane', 'Excel', 'EBP', 'Outils bureautiques', 'Communication client'],
  ...
  en: {
    ...
    valuePoints: [
      ...
      'Client communication and file follow-up quality',
    ],
    toolsTitle: 'Tools and environment',
    tools: ['Pennylane', 'Excel', 'EBP', 'Office tools', 'Client communication'],
